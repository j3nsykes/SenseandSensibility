...
const char* ssid = "IxDstudioWIFI2.4Ghz"; // wifi ID
const char* pass = "Lovelace"; // wifi password
const char* host = "http://192.168.0.142:8000/query"; // route provided by runway
